...
# 创建可视化结果保存文件夹
os.makedirs('visualizations_baseonsolutions1', exist_ok=True)
...
class Visualizer:
    """实现5项可视化功能（删除3D TSNE）"""
    def __init__(self, label_encoder, save_dir='visualizations_baseonsolutions1', dpi=Config.PLOT_DPI):
...
def main():
    ...
    try:
        ...
        print("\n🎉 训练完成！所有结果已保存至 visualizations_baseonsolutions1 文件夹")
